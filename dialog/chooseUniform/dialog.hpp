class helogame_rscChooseUniform {
	idd = CHOOSEUNIFORM_IDD_DIALOG;
	movingEnable = false;
    enableSimulation = true;
    onUnload = "_this call helogame_chooseUniform_fnc_onUnload";
	...
	class controls {
        class item0: mcd_RscActivePictureKeepAspect {
            ...
            action = "[0] call helogame_chooseUniform_fnc_onUniformSelected";
        };
        class item1: mcd_RscActivePictureKeepAspect {
            ...
            action = "[1] call helogame_chooseUniform_fnc_onUniformSelected";
        };
        class item2: mcd_RscActivePictureKeepAspect {
            ...
            action = "[2] call helogame_chooseUniform_fnc_onUniformSelected";
        };
        class buttonReroll: mcd_RscButton {
            ...
            h = CHOOSEUNIFORM_TOPBAR_H;
            font = "EtelkaMonospacePro";
            onButtonClick = "_this call helogame_chooseUniform_fnc_onButtonReroll";
        };
        class buttonConfirm: mcd_RscButton {
            ...
            font = "EtelkaMonospacePro";
            text = "CONFIRM";
            onButtonClick = "_this call helogame_chooseUniform_fnc_onButtonConfirm";
        };
